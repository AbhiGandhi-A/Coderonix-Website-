  ...
  useEffect(() => {
    ...
    newSocket.on('connect', () => {
      ...
      if (user && user.group_id) {
        newSocket.emit('join-group', { groupId: user.group_id, userId: user.id, name: user.name });
      }
    });
    ...
    newSocket.on('analytics-update', (data) => {
        // This is a new type of notification, maybe we just want to update the data directly
        // rather than showing a notification toast. The Analytics component will handle this.
